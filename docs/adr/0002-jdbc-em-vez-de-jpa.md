...
- SQL que roda é exatamente o SQL escrito, sem lazy loading, cascade ou dirty-checking
  implícitos. Isso é justamente o tipo de comportamento arriscado numa tabela append-only
...
- Sem mapeamento objeto-relacional pra manter sincronizado com o schema, é um record e uma
  query, só isso.
